    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        public int cargarEnSQL(DataTable tabla)
        {
            ...
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection("Data Source=.;Initial Catalog=DBCARGA;Integrated Security=True"))
                {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            decimal eee = decimal.Parse(de);
            bool re = decimal.TryParse(de,NumberStyles.AllowDecimalPoint, new CultureInfo("es-PE"), out it);

            DataTable table = new DataTable() { Locale = new CultureInfo("es-PE") };
            table.Columns.Add("data1", typeof(decimal));
            table.Columns.Add("data2", typeof(decimal));

            table.Rows.Add(eee, it);

            using (SqlConnection cn = new SqlConnection("Data Source=.;Initial Catalog=DBCARGA;Integrated Security=True"))
            {
                SqlCommand cmd = new SqlCommand("usp_cargardecimal", cn);
